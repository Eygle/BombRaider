...
Map::FufuBomb::FufuBomb(Character::Character *origin)
  : ABomb(BombInfo(3, Map::CLASSIC_BOX,
...
Map::FufuBomb::FufuBomb(int x, int y, Map::GameMap &map,
